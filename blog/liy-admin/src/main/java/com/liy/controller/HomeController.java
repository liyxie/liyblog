...
public class HomeController {
    ...
    @Schema(description = "首页各种统计信息", httpMethod = "GET", response = ResponseResult.class, notes = "首页各种统计信息")
    ...
    @Schema(description = "仪表盘文章、ip用户、留言统计", httpMethod = "GET", response = ResponseResult.class, notes = "首页文章、ip用户、留言统计")
    ...
    @Schema(description = "服务器监控", httpMethod = "GET", response = ResponseResult.class, notes = "服务器监控")

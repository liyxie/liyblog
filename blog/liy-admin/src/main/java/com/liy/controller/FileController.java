...
public class FileController {
    ...
    @Schema(description = "上传文件",httpMethod = "POST", response = ResponseResult.class, notes = "上传文件")
    ...
    @Schema(description = "批量删除文件",httpMethod = "DELETE", response = ResponseResult.class, notes = "批量删除文件")

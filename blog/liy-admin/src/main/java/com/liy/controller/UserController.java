...
public class UserController {
    ...
    @Schema(description = "用户列表", httpMethod = "GET", response = ResponseResult.class, notes = "用户列表")
    ...
    @Schema(description = "添加用户", httpMethod = "POST", response = ResponseResult.class, notes = "添加用户")
    ...
    @Schema(description = "用户详情", httpMethod = "GET", response = ResponseResult.class, notes = "用户详情")
    ...
    @Schema(description = "修改用户", httpMethod = "PUT", response = ResponseResult.class, notes = "修改用户")
    ...
    @Schema(description = "删除用户", httpMethod = "DELETE", response = ResponseResult.class, notes = "删除用户")
    ...
    @Schema(description = "获取当前登录用户信息", httpMethod = "GET", response = ResponseResult.class, notes = "获取当前登录用户信息")
    public ResponseResult getCurrentUserInfo() {
        return userService.getCurrentUserInfo();
    }

    @GetMapping(value = "/getUserMenu")
    @Schema(description = "获取用户菜单", httpMethod = "GET", response = ResponseResult.class, notes = "获取用户菜单")
    ...
    @Schema(description = "修改密码", httpMethod = "POST", response = ResponseResult.class, notes = "修改密码")
    ...
    @Schema(description = "查看在线用户", httpMethod = "GET", response = ResponseResult.class, notes = "查看在线用户")
    ...
    @Schema(description = "踢人下线", httpMethod = "GET", response = ResponseResult.class, notes = "踢人下线")

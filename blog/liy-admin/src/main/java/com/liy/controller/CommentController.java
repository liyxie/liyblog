...
public class CommentController {
    ...
    @Schema(description = "评论列表", httpMethod = "GET", response = ResponseResult.class, notes = "评论列表")
    ...
    @Schema(description = "批量删除评论", httpMethod = "DELETE", response = ResponseResult.class, notes = "批量删除评论")

      ...
      <view class="login__wrapper tn-padding">
        ...
        <view class="login__info tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
          ...
          <block v-if="currentModeIndex === 0">
			  <tn-form :model="form" ref="form" style="width: 100%;">
				    <tn-form-item  prop="nickname" :borderBottom="false">
						<view class="login__info__item__input tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-left">
						  ...
						  <view class="login__info__item__input__content">
						    <input maxlength="20" type="nickname" @blur="change" v-model="form.nickname" placeholder-class="input-placeholder" placeholder="请输入新昵称" />
						  </view>
						</view>
					</tn-form-item>
					 <tn-form-item  prop="intro" :borderBottom="false">
						 <view class="login__info__item__input tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-left">
						   <view class="login__info__item__input__left-icon">
						     <view class="tn-icon-identity"></view>
						   </view>
						   <view class="login__info__item__input__content">
						     <input maxlength="20" type="text" v-model="form.intro" placeholder-class="input-placeholder" placeholder="请输入简介" />
						   </view>
						 </view>
					 </tn-form-item>
			  </tn-form>
          ...
          <block v-if="currentModeIndex === 1">
           ...
           <view class="login__info__item__input tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-left">
			...
			<view class="login__info__item__input tn-flex tn-flex-direction-row tn-flex-nowrap tn-flex-col-center tn-flex-row-left">
			  ...
			  <view class="login__info__item__input__content">
			    <input :password="!showPassword" placeholder-class="input-placeholder" placeholder="请输入旧密码" />
			  </view>
          ...
          <view class="login__info__item__button tn-bg-blue tn-color-white" hover-class="tn-hover" :hover-stay-time="150" @click="handleSubmit">{{ '修改'}}</view>
				...
				this.$refs.form.validate(valid => {
				  if (valid) {
					updateUserInfo(this.form).then(res =>{
						...
						if(this.form.intro){
							userInfo.intro = this.form.intro
						}
